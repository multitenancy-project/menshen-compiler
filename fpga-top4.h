...
#ifndef _FPGA_TOP4_TOP4_H_
#define _FPGA_TOP4_TOP4_H_
...
*/
class FPGAToP4 : public Inspector {
 ...
 public:
    ...
    FPGAToP4(Util::SourceCodeBuilder& builder, bool showIR, cstring mainFile = nullptr) :
            ...
            outStream(nullptr),
            mainFile(mainFile)
    { visitDagOnce = false; setName("FPGAToP4"); }
    FPGAToP4(std::ostream* outStream, bool showIR, cstring mainFile = nullptr) :
            expressionPrecedence(DBPrint::Prec_Low),
            isDeclaration(true),
            showIR(showIR),
            withinArgument(false),
            ...
            mainFile(mainFile)
    { visitDagOnce = false; setName("FPGAToP4"); }
    FPGAToP4() :  // this is useful for debugging
            expressionPrecedence(DBPrint::Prec_Low),
            isDeclaration(true),
            showIR(false),
            withinArgument(false),
